<?php get_header();?>
	...
	<?php
		...
		echo $pt = get_post_type();
		if ($pt == 'portfolio'){ ?>

		<?php
			if (atom_get_post_meta_key('layout-type') == 1){
				get_template_part('template/portfolio/portfolio','single-two'); }
			elseif (atom_get_post_meta_key('layout-type') == 2){
				get_template_part('template/portfolio/portfolio','single-three'); }
			else{	get_template_part('template/portfolio/portfolio','single'); }
			}
		else{?>
