				...
				'fields' => array(
						...
						array(
								...
								'choices' => array(
										...
										array(
												'value' => '2',
												'label' => __('Style 3', 'atom')
										)
								)
						),


								//Style 1 Config Start
								//====================
								...
								array(
										'label' => __('Gallery Images', 'theme-text-domain'),
										'id' => 'gallery-images',
										'condition' => 'gallery-show:is(on)',
										'type' => 'list-item',
										'settings' => array(

											array(
													'label' => __('Content Sliders Subtitle', 'theme-text-domain'),
													'desc' => __('Write Content Sliders Subtitle Here', 'theme-text-domain'),
													'id' => 'content-sliders-title',
													'type' => 'text'
											),
											array(
													'label' => __('Content Sliders Description', 'theme-text-domain'),
													'desc' => __('Write Content Sliders Description Here', 'theme-text-domain'),
													'id' => 'content-sliders-desc',
													'type' => 'textarea-simple'
											),
								...
								//testimoni start
									array(
											'label' => __('Testimonial', 'theme-text-domain'),
											'id' => 'testimonial',
											'type' => 'on-off',
											'condition' => 'layout-type:is(1)',
											'std' => 'off'
									),

									array(
											'label' => __('Testimonial List', 'theme-text-domain'),
											'id' => 'testimonial-list',
											'condition' => 'testimonial:is(on)',
											'type' => 'list-item',
											'settings' => array(

												array(
														'label' => __('Testimonial Content', 'theme-text-domain'),
														'desc' => __('Write Testimonial Content Here', 'theme-text-domain'),
														'id' => 'testimonial-desc',
														'type' => 'textarea-simple'
												),
												array(
														'label' => __('Person', 'theme-text-domain'),
														'desc' => __('Write Person who write testimonial Here', 'theme-text-domain'),
														'id' => 'person',
														'type' => 'text'
												),
												array(
														'label' => __('Company', 'theme-text-domain'),
														'desc' => __('Write Person who write testimonial Here', 'theme-text-domain'),
														'id' => 'person',
														'type' => 'text'
												),
								...
								array(
										'label' => __('Project Info', 'theme-text-domain'),
										'id' => 'project-info',
										...
										'settings' => array(
												...
												array(
														'label' => __('Subtitle Project', 'theme-text-domain'),
														'desc' => __('Name of subtitle project', 'theme-text-domain'),
														'id' => 'subtitle-project-info',
														'type' => 'text'
												),
												array(
														'label' => __('Description Project', 'theme-text-domain'),
														'desc' => __('Description of subtitle project', 'theme-text-domain'),
														'id' => 'desc-project-info',
														'type' => 'text'
												),
												array(
														'id'          => 'project-info-checkbox',
														'label'       => 'Checkbox',
														'desc'        => '',
														'std'         => 'yes',
														'type'        => 'checkbox',
													...
													array(
															...
															'id' => 'desc-project-info',
															'type' => 'text',
															'condition' => 'project-info-checkbox:is(yes)'
													),
								...
								array(
										'label' => __('Show Callout', 'theme-text-domain'),
										'id' => 'callout-show',
								...
								array(
										'label' => __('Callout Title', 'atom'),
										'desc' => __('Input Your Callout Title Here', 'atom'),
										'id' => 'callout-title',
										'std' => '',
										'type' => 'text',
										'condition' => 'callout-show:is(on)'
								),
								array(
										'label' => __('Callout Description', 'theme-text-domain'),
										'desc' => __('Input Your Callout Description Here', 'theme-text-domain'),
										'id' => 'callout-desc',
										'type' => 'textarea-simple',
										'condition' => 'callout-show:is(on)'
								),
								...
								array(
										'label' => __('Callout Background Image', 'theme-text-domain'),
										'id' => 'callout-bg-image',
										'type' => 'upload',
										'condition' => 'callout-show:is(on)',
										'std' => ''
								...
								array(
										'label' => __('Callout Button Name', 'theme-text-domain'),
										'desc' => __('Input Your Callout Button Name Here', 'theme-text-domain'),
										'id' => 'callout-button',
										'type' => 'text',
										'condition' => 'callout-show:is(on)'
								),
								...
								array(
										'label' => __('Callout Target Link', 'theme-text-domain'),
										'desc' => __('Input Your Callout Target Link Here', 'theme-text-domain'),
										'id' => 'callout-target-link',
										'type' => 'text',
										'condition' => 'callout-show:is(on)'
								),
								...
								array(
										'label' => __('Show Carousel', 'theme-text-domain'),
										'id' => 'carousel-show',
								...
								array(
										'label' => __('Carousel Title', 'theme-text-domain'),
										'id' => 'carousel-title',
										'type' => 'text',
										'std' => '',
										'condition' => 'carousel-show:is(on)'
								),

								array(
										'label' => __('Carousel Desc', 'theme-text-domain'),
										'id' => 'carousel-desc',
										'type' => 'text',
										'std' => '',
										'condition' => 'carousel-show:is(on)'
								...
								array(
										'label' => __('Carousel List', 'theme-text-domain'),
										'id' => 'carousel-gallery',
										'type' => 'list-item',
										'condition' => 'carousel-show:is(on)',
										'settings' => array(
												...
												array(
														'label' => __('Target Link', 'theme-text-domain'),
														'id' => 'target-link',
														'type' => 'text'
												),
						...
						//Style 1 Config End//
						array(
								'label' => __('Portfolio Thumbnail List', 'theme-text-domain'),
								'id' => 'portfolio-thumbnail-list',
								'type' => 'tab'
						),

						array(
								'label' => __('Portfolio Thumbnail', 'theme-text-domain'),
								'id' => 'portfolio-thumbnail',
								'type' => 'list-item',
								'settings' => array(

										array(
												'label' => __('Portfolio Thumbnail Title', 'theme-text-domain'),
												'id' => 'portfolio-thumbnail-title',
												'type' => 'text'
										),

										array(
												'label' => __('Portfolio Target Link', 'theme-text-domain'),
												'id' => 'portfolio-target-link',
												'type' => 'text'
										),
